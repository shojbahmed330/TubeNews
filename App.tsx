...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen lg:overflow-hidden bg-slate-950">
      {/* Sidebar Controls */}
      <div className="w-full lg:w-96 bg-slate-900 border-b lg:border-b-0 lg:border-r border-slate-800 p-4 lg:p-5 lg:overflow-y-auto custom-scrollbar">
      ...
      <div className="flex-1 flex flex-col items-start p-4 lg:p-10 overflow-y-auto custom-scrollbar bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-slate-900 to-black">
        <div className="w-full max-w-5xl mx-auto">
          <div className="w-full aspect-video bg-black rounded-xl lg:rounded-2xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden border border-slate-800 relative group mb-6 lg:mb-8">
            <VideoPreview 
              state={state} 
          ...
          {videoBlobUrl && (
            <div className="mb-8 flex flex-col items-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
               <div className="bg-emerald-500/10 border border-emerald-500/50 text-emerald-400 px-4 py-2 lg:px-6 lg:py-3 rounded-xl text-xs lg:text-sm font-semibold flex items-center gap-2">
              ...
              <a 
                ...
                className="w-full lg:w-auto px-6 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-3 shadow-xl shadow-emerald-900/40 hover:scale-105 active:scale-95 text-sm lg:text-base"
              >
